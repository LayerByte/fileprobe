...
Fileprobe is a defensive cybersecurity and system-administration project written in Modern C++20. It focuses on read-only analysis, validation, clear output, and safe handling of user-provided files, URLs, hosts, or text.
...
Clone or copy this project folder, then follow the standard build or run command for Modern C++20.

## Usage

`cmake -S . -B build && cmake --build build`
`./build/fileprobe sample.bin`

## Example

```text
fileprobe sample.bin --strings
```
